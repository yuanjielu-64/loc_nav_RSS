...
namespace Antipatrea {
    ...
    bool DWAPlanner::handleNoMapPlanning(geometry_msgs::msg::Twist &cmd_vel) {
    ...
    bool DWAPlanner::handleNormalSpeedPlanning(geometry_msgs::msg::Twist &cmd_vel,
    ...
    bool DWAPlanner::handleLowSpeedPlanning(geometry_msgs::msg::Twist &cmd_vel,
                                            std::pair<std::vector<PoseState>, bool> &best_traj, double dt) {
    ...
    void DWAPlanner::publishCommand(geometry_msgs::msg::Twist &cmd_vel, double linear, double angular) {
