...
namespace Antipatrea {
    ...
    TEBPlanner::TEBPlanner() {
        ...
        std::cout << "[INFO] " << "TEBPlanner initialized with official teb_local_planner library");
    }
    ...
    bool TEBPlanner::handleNoMapPlanning(geometry_msgs::msg::Twist &cmd_vel) {
    ...
    bool TEBPlanner::handleNormalSpeedPlanning(geometry_msgs::msg::Twist &cmd_vel, double dt) {
        normalParameters(*robot);
    ...
    bool TEBPlanner::handleLowSpeedPlanning(geometry_msgs::msg::Twist &cmd_vel, double dt) {
    ...
    bool TEBPlanner::callTEBPlanner(geometry_msgs::msg::Twist &cmd_vel) {
